...
public class WebModality_Sanity_Translation_For_Arabic_SIP extends BaseTest {
	...
	public WebModality_Sanity_Translation_For_Arabic_SIP(String browser) {
		super(browser);
	}
	...
	public void VirgilWebSanityScreenshots_Arabic() throws Exception {
		...
		studyNavigatorDashBoardPage.selectSubjectLanguage("Arabic");
