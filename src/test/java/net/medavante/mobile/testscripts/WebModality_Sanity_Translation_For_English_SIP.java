...
public class WebModality_Sanity_Translation_For_English_SIP extends BaseTest {
	...
	public WebModality_Sanity_Translation_For_English_SIP(String browser) {
		super(browser);
	}
	...
	public void VirgilWebSanityScreenshots_English() throws Exception {
