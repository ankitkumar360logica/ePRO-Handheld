...
public class Handheld_Translation_Sanity_Afrikaans_SIP extends BaseTest {

	private String language = "Afrikaans";
	...
	public Handheld_Translation_Sanity_Afrikaans_SIP(String driver) {
		super(driver);
	}
	...
	public void eCOAHandheldScriptWorkflow_Afrikaans() throws Exception {
