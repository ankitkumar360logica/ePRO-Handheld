...
public class Handheld_Translation_v2_SIP extends BaseTest {
	...
	public void eCOAHandheldScriptWorkflow() throws Exception {
		...
		reportLog("Image 1");
		mobileLoginPage.configurationForRegisterTheSubject("6EFB-A6DF-4EF8-8B7C");
		...
		reportLog("Image 5\nNote:\nSecret Question count is dynamic.");
...
//	    reportLog("10.1:MobileView Connect to the internet");
		...
		reportLog("Image 16\nNote:\nDiary1: Placeholder text,\nno translation needed.");
		//questionnairesPage = dashborad.clickOnQuestionnairesTab();
		dashborad.captureQuestionnaireScreen();
		Thread.sleep(7000);
		...
		reportLog("Image 23");
		mobileLoginPage.tapByCoordinate(954, 2116, true);
		//mobileLoginPage.tapByCoordinate(656, 1426, true);
		...
		mobileLoginPage.tapByCoordinate(954, 2116, false);
		//mobileLoginPage.tapByCoordinate(656, 1426, false);
		messagePage.inputTxtInMsgSubjectField("abcd");
...
//		Thread.sleep(3000);
		...
		deactivateSubject("AutoCHHongKong11");
		
		mobileLoginPage = androidSetUp();	
		
		mobileLoginPage.verifyInstructionMessageText(registerScreenInstruction);
		mobileLoginPage.configurationForRegisterTheSubject("6B1A-B7EE-4684-8F50"); //Span20Arg
		mobileLoginPage.clickOnAcceptBtn(false); 
		...
		deactivateSubject("ChineseHongKong");
		...
		reportLog("Image 68");
		mobileLoginPage.configurationForRegisterTheSubject("954A-4D7B-44CC-BC4C"); 
	...
	public void sendingMessage() throws Exception {
		...
		studyNavigatorDashBoardPage.selectStudy(studyName, Constants.testSite);
		studyNavigatorDashBoardPage
				.searchFilterValueByColumnNameAndValue(Constants.StudyDashBoard_columnName_Subject, "AutoCHHongKong11");
		subjectDetailPage = studyNavigatorDashBoardPage.clickOnSearchedSubject("AutoCHHongKong11");
