...
public class WebModality_Sanity_Translation_For_Afrikaans_SIP extends BaseTest {
	...
	public WebModality_Sanity_Translation_For_Afrikaans_SIP(String browser) {
		super(browser);
	}
	...
	public void VirgilWebSanityScreenshots_Afrikaans() throws Exception {
		...
		studyNavigatorDashBoardPage.selectSubjectLanguage("Afrikaans");
		...
		reportLog("Verify Terms and Condition personal data and Accept button.");
		subjectDetailPage.verifyTermsConditionPage();
