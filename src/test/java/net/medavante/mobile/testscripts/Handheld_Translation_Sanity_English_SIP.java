...
public class Handheld_Translation_Sanity_English_SIP extends BaseTest {
	...
	public Handheld_Translation_Sanity_English_SIP(String driver) {
		super(driver);
	}
	...
	public void eCOAHandheldScriptWorkflow_English() throws Exception {		
	...
	public void updateSubjectValueInPropertiesFile(ITestResult result) throws InterruptedException {
			...
			subjectDetailPage.deactivateSubjectConfiguration(SITEUserName, SITE_Password);
